...
- **프로젝트 OT** : 프로젝트 기간 시작일
- **프로젝트 본 기간** : OT 직후 ~ 프로젝트 기간 종료일 D-1
- **프로젝트 발표** : 프로젝트 기간 마감일


## 프로젝트 개요

- **사진 속에 있는 최대 4개의 알약의 이름(클래스)과 위치(바운딩 박스)를 검출하는 모델을 구현**
- **Leaderbord를 통해 모델 성능**
...
| 역할명 | 상세 |
|---|---|
| Project Manager 권혁상 | - 프로젝트의 협업 과정을 매니징하는 역할 |
| Data Engineer 김하루, 최민식 | - 데이터 수집, 정제 및 전처리를 담당하고 데이터 파이프라인을 구축 |
| Model Architect 권순균| - 딥러닝 모델을 설계하고 아키텍처를 결정 |
| Experimentation Lead 김다혜| - 다양한 실험을 주도하고, 하이퍼파라미터 튜닝 및 모델 성능 평가를 담당 |
## 폴더 구조
